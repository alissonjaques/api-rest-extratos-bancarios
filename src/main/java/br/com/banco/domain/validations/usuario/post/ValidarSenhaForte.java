...
@Component()
public class ValidarSenhaForte implements IValidacaoCriarUsuario {
    public void validar(CreateUsuarioDTO createUsuarioDTO){
        String senha = createUsuarioDTO.senha();
        String mensagem = "Não foi possível criar o usuário.<br>Motivo: a senha informada é fraca. A senha deve conter:" +
